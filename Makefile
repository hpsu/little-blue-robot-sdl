...
SDL_LIB_WIN64 = -static -static-libstdc++ -static-libgcc -L/usr/x86_64-w64-mingw32/lib -L/usr/x86_64-w64-mingw32/lib -lmingw32 -lSDL2main -lSDL2 -mwindows -lwinpthread -lwinmm -lole32 -loleaut32 -limm32 -lversion
